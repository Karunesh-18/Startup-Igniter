...
def get_licensing_advisor_agent(
    ...
    ai_logger.info(f"Initializing LicensingAdvisorAgent: tier={model_tier}, mock={mock_mode}")
    llm = LLMFactory.get_llm(model_tier=model_tier, temperature=temperature, api_key=api_key, mock_mode=mock_mode)

    role = "Software Licensing & Open-Source Compliance Specialist"
    goal = "Evaluate MIT, Apache-2.0, GPL, and commercial software license compliance risks."
    backstory = "IP Licensing counsel auditing open-source software dependencies and commercial licensing models."
    ...
    return {
        "agent_name": "licensing_advisor_agent",
        "role": role,
        "goal": goal,
        "backstory": backstory,
        "llm": llm,
