...
def get_pricing_strategy_agent(
    ...
    ai_logger.info(f"Initializing PricingStrategyAgent: tier={model_tier}, mock={mock_mode}")
    llm = LLMFactory.get_llm(model_tier=model_tier, temperature=temperature, api_key=api_key, mock_mode=mock_mode)

    role = "SaaS Pricing Tier & Packaging Director"
    goal = "Formulate value-based tier pricing, freemium conversion points, and annual vs monthly pricing plans."
    backstory = "Growth pricing consultant structuring B2B software price tiers and willingness-to-pay elasticity."
