...
def get_architecture_recommendation_agent(
    ...
    ai_logger.info(f"Initializing ArchitectureRecommendationAgent: tier={model_tier}, mock={mock_mode}")
    llm = LLMFactory.get_llm(model_tier=model_tier, temperature=temperature, api_key=api_key, mock_mode=mock_mode)

    role = "Principal Systems Architect"
    goal = "Design high-level microservices, API architecture, data flows, and component diagrams."
    backstory = "Cloud enterprise architect designing resilient software systems and microservices."
    ...
    return {
        "agent_name": "architecture_recommendation_agent",
        "role": role,
        "goal": goal,
        "backstory": backstory,
        "llm": llm,
