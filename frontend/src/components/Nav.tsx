...
export default function Nav({ onLaunch, onDashboard }: { onLaunch: () => void; onDashboard: () => void }) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <button onClick={onDashboard} className="group flex items-center gap-2.5">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <button onClick={onDashboard} className="btn-ghost rounded-full px-4 py-2 text-sm text-white/80">
            Dashboard
          </button>
